...
var (
	accessId       int64    = 2200259522
	secretKey      string   = "95f44d07de37e871d036e1a39e51a0822"
	...
	messageAndroid          = EasyMessageAndroid("测试信鸽推送", "测试信鸽推送 Android API")
	messageIOS              = EasyMessageIOS("测试信鸽推送 iOS API", IOSENV_DEV)
)
